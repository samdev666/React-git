...
export enum Right {
  ...
  IDEAL_INCOME_MANAGEMENT = "IDEAL_INCOME_MANAGEMENT",
  IDEAL_LIFESTYLE_MANAGEMENT = "IDEAL_LIFESTYLE_MANAGEMENT",
...
export const defaultUserRights: Right[] = [
  ...
  Right.IDEAL_INCOME_MANAGEMENT ,
  Right.IDEAL_LIFESTYLE_MANAGEMENT ,
