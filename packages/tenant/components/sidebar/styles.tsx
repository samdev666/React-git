...
export const StyledSubMenuItemContainer = styled.a<{
  ...
  border-width: ${(props) =>
    !props.sidebarOpen && props.active && '0px 0px 0px 3px'};
  border-radius: ${(props) =>
    !props.sidebarOpen ? '0px 6px 6px 0px' : '6px'};
  border-style: ${(props) => !props.sidebarOpen && props.active && 'solid'};
  border-color: ${(props) =>
    !props.sidebarOpen && props.active && brandColour.primaryMain};
  color: ${(props) =>
    props.active ? brandColour.primaryMain : greyScaleColour.secondaryMain};
  justify-content: ${(props) => props.sidebarOpen && 'center'};
`;
...
export const StyledSecondarySubMenuContainer = styled.a<{
  ...
  text-decoration: none;
  align-items: center;
  background-color: ${(props) => !props.hasSubMenuItem && props.active && brandColour.primary70};
  border-width: ${(props) => !props.hasSubMenuItem && !props.sidebarOpen && props.active && '0px 0px 0px 3px'};
  border-radius: ${(props) => !props.hasSubMenuItem && (!props.sidebarOpen ? '0px 6px 6px 0px' : '6px')};
  border-style: ${(props) => !props.hasSubMenuItem && !props.sidebarOpen && props.active && 'solid'};
  border-color: ${(props) => !props.hasSubMenuItem && !props.sidebarOpen && props.active && brandColour.primaryMain};
  color: ${(props) => !props.hasSubMenuItem && (props.active ? brandColour.primaryMain : greyScaleColour.secondaryMain)};
  justify-content: ${(props) => props.sidebarOpen && 'center'};
`;
